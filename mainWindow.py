...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableComboBox_tab4 = QtWidgets.QComboBox(self.tab_4)
        self.tableComboBox_tab4.setGeometry(QtCore.QRect(10, 40, 181, 31))
        self.tableComboBox_tab4.setObjectName("tableComboBox_tab4")
        self.chooseATableLabel1 = QtWidgets.QLabel(self.tab_4)
        self.chooseATableLabel1.setGeometry(QtCore.QRect(10, 10, 211, 31))
        self.chooseATableLabel1.setObjectName("chooseATableLabel1")
        self.tableSubmitButton_tab4 = QtWidgets.QPushButton(self.tab_4)
        self.tableSubmitButton_tab4.setGeometry(QtCore.QRect(10, 70, 113, 32))
        self.tableSubmitButton_tab4.setObjectName("tableSubmitButton_tab4")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.chooseATableLabel1.setText(_translate("MainWindow", "Choose a table to insert values to"))
        self.tableSubmitButton_tab4.setText(_translate("MainWindow", "Next"))
